...
public class Kernel
{
   ...
   // Sizes
   private final static int diskBlocks = 1000;
         ...
         case INTERRUPT_SOFTWARE: // System calls
            switch( cmd ) { 
               ...
               case READ:
					...
					//TODO: rewrite read to be like write, using FileTableEntry -- just need to uncomment
					//the one line before "return ERROR"?
